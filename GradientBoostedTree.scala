...
object GradientBoostedTree {
    def main(args: Array[String]) {
        ...
        val resultsDF = Seq(Row("Gradient-boosted Tree", accuracy, precision, recall, f1, auc, trainingTime, dataset, hyperparameters.toString()))
        ...
        val someDF = spark
            ...
            .coalesce(1)
            .write
            .csv("/home/gta/TeMIA-NT/results/GradientBoostedTree")
