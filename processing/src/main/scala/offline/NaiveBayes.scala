...
object NaiveBayes {
    def main(args: Array[String]) {
        ...
        val resultsDF = Seq(Row("Naive Bayes", accuracy, precision, recall, f1, auc, trainingTime, dataset, hyperparameters.toString()))
        ...
        val someDF = spark
            ...
            .coalesce(1)
            .write
            .csv("/home/gta/TeMIA-NT/results/NaiveBayes")
