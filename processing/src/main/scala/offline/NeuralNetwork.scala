...
object NeuralNetwork {
    def main(args: Array[String]) {
        ...
        // Creates a DataFrame with the resulting metrics, and save them to a csv file
        val resultsDF = Seq(Row("Multilayer Perceptron", accuracy, precision, recall, f1, auc, trainingTime, dataset, hyperparameters.toString()))
        ...
        val someDF = spark
            ...
            .coalesce(1)
            .write
            .csv("/home/gta/TeMIA-NT/results/NeuralNetwork")
