...
if __name__ == "__main__":
    ...
    file = open("/home/gta/catraca/results/memory/python/csv/decisionTreeCrossVal.csv", "a+") # Results for MATLAB
...
#               filename += "master-"+coresList[0]+"Cores"
    ...
    file = open("/home/gta/catraca/results/memory/python/"+ dirname +"/"+ filename +"-decisionTreeCrossVal.txt", "a+")
