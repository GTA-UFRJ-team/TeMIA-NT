...
if __name__ == "__main__":
    ...
    spark = SparkSession\
        .builder\
        .appName("TrainCrossValGradientBoostedTreeIDS-Python")\
        .getOrCreate()
    ...
    stepSize = bestModel.stages[-1]._java_obj.parent().getStepSize()

    # Stop spark session
    spark.stop()

    file = open("/home/gta/catraca/results/python/csv/gradientBoostedTreeCrossVal.csv", "a+") # Results for MATLAB
...
#               filename += "master-"+coresList[0]+"Cores"
    ...
    file = open("/home/gta/catraca/results/python/"+ dirname +"/"+ filename +"-gradientBoostedTreeCrossVal.txt", "a+")
