...
if __name__ == "__main__":
    ...
    spark = SparkSession\
        .builder\
        .appName("TrainLinearSupportVectorMachineIDS-Python")\
        .getOrCreate()
    ...
    file = open("/home/gta/catraca/results/python/csv/linearSVMCrossVal.csv", "a+") # Results for MATLAB
...
#               filename += "master-"+coresList[0]+"Cores"
    ...
    file = open("/home/gta/catraca/results/python/"+ dirname +"/"+ filename +"-linearSVMCrossVal.txt", "a+")
