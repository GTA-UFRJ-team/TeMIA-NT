...
if __name__ == "__main__":
    ...
    spark = SparkSession\
        .builder\
        .appName("TrainLogisticRegressionIDS-Python")\
        .getOrCreate()
    ...
    # Create a LogisticRegression model trainer
    lr = LogisticRegression(regParam=0.005, elasticNetParam=0.5)
    ...
    elasticNetParam = bestModel._java_obj.parent().getElasticNetParam()

    # Stop spark session
    spark.stop()

    file = open("/home/gta/catraca/results/python/csv/logisticRegressionCrossVal.csv", "a+") # Results for MATLAB
...
#               filename += "master-"+coresList[0]+"Cores"
    ...
    file = open("/home/gta/catraca/results/python/"+ dirname +"/"+ filename +"-logisticRegressionCrossVal.txt", "a+")
