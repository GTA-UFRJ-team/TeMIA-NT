...
if __name__ == "__main__":
    ...
    file = open("/home/gta/catraca/results/python/csv/naiveBayesCrossVal.csv", "a+") # Results for MATLAB
...
#               filename += "master-"+coresList[0]+"Cores"
    ...
    file = open("/home/gta/catraca/results/python/"+ dirname +"/"+ filename +"-naiveBayesCrossVal.txt", "a+")
