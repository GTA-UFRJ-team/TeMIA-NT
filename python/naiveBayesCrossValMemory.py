...
if __name__ == "__main__":
    ...
    spark = SparkSession\
        .builder\
        .appName("TrainNaiveBayesIDS-Python")\
        .getOrCreate()
    ...
    smoothing = bestModel._java_obj.parent().getSmoothing()

    # Stop spark session
    spark.stop()

    file = open("/home/gta/catraca/results/memory/python/csv/naiveBayesCrossVal.csv", "a+") # Results for MATLAB
...
#               filename += "master-"+coresList[0]+"Cores"
    ...
    file = open("/home/gta/catraca/results/memory/python/"+ dirname +"/"+ filename +"-naiveBayesCrossVal.txt", "a+")
