...
if __name__ == "__main__":
    ...
    file = open("/home/gta/catraca/results/python/csv/neuralNetworkCrossVal.csv", "a+") # Results for MATLAB
...
#               filename += "master-"+coresList[0]+"Cores"
    ...
    file = open("/home/gta/catraca/results/python/"+ dirname +"/"+ filename +"-neuralNetworkCrossVal.txt", "a+")
