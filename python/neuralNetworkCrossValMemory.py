...
if __name__ == "__main__":
    ...
    file = open("/home/gta/catraca/results/memory/python/csv/neuralNetworkCrossVal.csv", "a+") # Results for MATLAB
...
#               filename += "master-"+coresList[0]+"Cores"
    ...
    file = open("/home/gta/catraca/results/memory/python/"+ dirname +"/"+ filename +"-neuralNetworkCrossVal.txt", "a+")
