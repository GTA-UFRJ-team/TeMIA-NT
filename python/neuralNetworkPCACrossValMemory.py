...
if __name__ == "__main__":
    ...
    spark = SparkSession\
        .builder\
        .appName("TrainPCANeuralNetworkIDS-Python")\
        .getOrCreate()
    ...
    layers = bestModel._java_obj.parent().getLayers()

    # Stop spark session
    spark.stop()

    file = open("/home/gta/catraca/results/memory/python/csv/neuralNetworkPCACrossVal.csv", "a+") # Results for MATLAB
...
#               filename += "master-"+coresList[0]+"Cores"
    ...
    file = open("/home/gta/catraca/results/memory/python/"+ dirname +"/"+ filename +"-neuralNetworkPCACrossVal.txt", "a+")
