...
object Catraca {
	...
	def main(args: Array[String]) = {
		...
		val csvFile: File = "/home/gta/catraca/results/scala/csv/linearSVMCrossVal.csv"
			.toFile
			.createIfNotExists()
		...
		val txtPath = "/home/gta/catraca/results/scala/" + dirname.toString() + "/" + filename.toString() + "-linearSVMCrossVal.txt"
